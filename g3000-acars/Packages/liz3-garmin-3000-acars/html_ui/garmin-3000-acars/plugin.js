...
(() => {
  ...
  var FAST_POLL_INTERVAL = 2e4;
  var FAST_POLL_DURATION = 12e4;
...
${content}`,
  ...
  var AcarsMessagePage = class extends import_msfs_wtg3000_gtc.GtcView {
    constructor(props) {
      ...
      this.contentRef = import_msfs_sdk.FSComponent.createRef();
    ...
    render() {
      ...
      return /* @__PURE__ */ msfssdk.FSComponent.buildComponent("div", { class: "acars-message-page" }, /* @__PURE__ */ msfssdk.FSComponent.buildComponent("div", { class: "header" }, /* @__PURE__ */ msfssdk.FSComponent.buildComponent("span", null, this.from)), /* @__PURE__ */ msfssdk.FSComponent.buildComponent(
        ...
        /* @__PURE__ */ msfssdk.FSComponent.buildComponent(import_msfs_wtg3000_gtc.GtcListItem, null, /* @__PURE__ */ msfssdk.FSComponent.buildComponent("div", { class: "content" }, /* @__PURE__ */ msfssdk.FSComponent.buildComponent("span", { ref: this.contentRef }, this.content)))
  ...
  var AcarsTabView = class extends import_msfs_wtg3000_gtc.GtcView {
    constructor(props) {
      ...
      if (isPrimary) {
        this.subscriptions.push(
          this.props.gtcService.bus.getSubscriber().on("acars_message_ack").handle((v) => {
        ...
        this.subscriptions.push(
          this.props.gtcService.bus.getSubscriber().on("acars_message_request").handle((v) => {
            const state = this.client.get();
            state[v.key].apply(this, Object.values(v.arguments || {}));
          })
        );
        this.subscriptions.push(
          this.props.gtcService.bus.getSubscriber().on("acars_status_param").handle((imp) => {
            ...
            if (v && v.length && (hoppieCode || isBeyondAtc)) {
              ...
              this.props.gtcService.bus.getPublisher().pub("acars_new_client", null, true, false);
            }
          })
        );
      } else {
        this.subscriptions.push(
          this.props.gtcService.bus.getSubscriber().on("acars_new_client").handle((v) => {
            if (!v) {
              this.client.set(null);
              this.canCreate.set(false);
              return;
  ...
  function getSettingsManager(bus) {
    if (!settingsManagerInstance) {
      settingsManagerInstance = new import_msfs_sdk.DefaultUserSettingManager(bus, [
        {
          defaultValue: GetStoredData("hoppie_code"),
          name: "acars_code"
        },
  ...
  // src/Interceptor.jsx
  var DataLinkButton = class extends import_msfs_sdk3.DisplayComponent {
    render() {
      return /* @__PURE__ */ msfssdk.FSComponent.buildComponent(
        import_msfs_garminsdk3.ImgTouchButton,
        {
          label: "ATC\nDatalink",
  ...
  var onMfdHomePage = (ctor, props, service) => {
    ...
    instance.render = () => {
      ...
      if (orig.children && orig.children[3] && orig.children[3].children) {
        orig.children[3].children.unshift(
          /* @__PURE__ */ msfssdk.FSComponent.buildComponent(DataLinkButton, { service })
        );
      }
      return orig;
    };
  ...
  var onWeightPage = (ctor, props, service, instance) => {
  ...
  var DataLinkSettingsButton = class extends import_msfs_sdk3.DisplayComponent {
    render() {
      return /* @__PURE__ */ msfssdk.FSComponent.buildComponent(
        import_msfs_garminsdk3.ImgTouchButton,
        {
    ...
    instance.render = () => {
      ...
      if (orig.children && orig.children[1] && orig.children[1].children) {
        orig.children[1].children.push(
          /* @__PURE__ */ msfssdk.FSComponent.buildComponent(DataLinkSettingsButton, { service })
        );
      }
      return orig;
    };
  ...
  var registerViews = (ctx, fms) => {
    ...
    ctx.registerView(
      import_msfs_wtg3000_gtc2.GtcViewLifecyclePolicy.Transient,
      "ACARS_SETTINGS",
      "MFD",
      (gtcService, controlMode, displayPaneIndex) => {
        return /* @__PURE__ */ msfssdk.FSComponent.buildComponent(
    ...
    constructor(binder) {
      ...
      if (title.includes("CJ3+"))
        this.onComponentCreating = (ctor, props) => {
          ...
          if (ctor.name === "GtcTouchButton" && props.label === "Set Empty\nWeight") {
            return onWeightPage(
              ctor,
              props,
